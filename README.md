...
FactSearch is an AI pipeline for verifying the factuality of LLM outputs. Provide FactSearch with an prompt and response generated by AI, and FactSearch will provide a comprehensive factuality assessment.
